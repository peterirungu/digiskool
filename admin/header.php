...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <a class="navbar-brand" href="#"><img class="img-responsive" src="./images/logo3.png" alt="RealEstate Management System"></a>
                        ...
                        <a href="#">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="media-heading"><strong><?php echo $login_session; ?> </strong>
                                    </h5>
